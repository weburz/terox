...
When stdout is not a terminal (piped into another command or redirected
to a file), the compact table is preserved but truncation is skipped so
descriptions stay intact for downstream consumers.
